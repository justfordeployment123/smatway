...
function MapPinIcon({ className = "w-16 h-16" }: { className?: string }) {
  return (
    ...
    <div className="pt-20">
      ...
      <section className="relative bg-gradient-to-br from-emerald-600 to-teal-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 max-w-3xl mx-auto">Connecting travelers and transporters across the World</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6">
              <div className="text-center">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">To make travel accessible, safe, and affordable for everyone across the World</p>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6">
              <div className="text-center">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">To become the World&apos;s leading transportation platform connecting communities</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg border border-slate-200 text-center hover:shadow-xl transition-shadow p-6">
              <div className="text-emerald-600 mb-4 flex justify-center"><SafetyIcon /></div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 text-center hover:shadow-xl transition-shadow p-6">
              <div className="text-emerald-600 mb-4 flex justify-center"><HeartIcon /></div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 text-center hover:shadow-xl transition-shadow p-6">
              <div className="text-emerald-600 mb-4 flex justify-center"><AwardIcon /></div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 text-center hover:shadow-xl transition-shadow p-6">
              <div className="text-emerald-600 mb-4 flex justify-center"><TrendingUpIcon /></div>
