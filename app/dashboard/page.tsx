    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <input type="text" placeholder="Enter departure country" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Departure City</label>
              <input type="text" placeholder="Enter departure city" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Destination Country</label>
              <input type="text" placeholder="Enter destination country" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Destination City</label>
              <input type="text" placeholder="Enter destination city" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </div>
            <div>
          ...
          <div className="flex justify-center pt-2">
            <button className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold px-12 py-2.5 rounded-lg border-0 shadow transition-all text-base">
              Search Routes
            </button>
          </div>
        </div>
      ...
      <div className="text-center py-12">
        <div className="flex flex-col items-center text-slate-600">
          <AntEmptySmall />
          <p className="mt-2 text-sm text-slate-500">Enter search criteria above and click &apos;Search Routes&apos; to find available rides</p>
        </div>
      </div>
    </div>
  );
