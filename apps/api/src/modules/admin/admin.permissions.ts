// Fine-grained permission strings used across the admin module. Keep this in
// sync with the frontend permission picker (apps/admin/lib/permissions.ts).
//
// Convention: "<resource>:<action>". SUPER_ADMIN bypasses all of these.
...
export const ADMIN_PERMISSIONS = {
  ...
  BUG_REPORTS_REPLY: 'bug-reports:reply',
...
/** Grouped for the admin-create UI's permission picker. */
export const ADMIN_PERMISSION_GROUPS: Array<{
  ...
  },
  {
    ...
    permissions: [
      ...
      { value: ADMIN_PERMISSIONS.BUG_REPORTS_READ, label: 'View bug reports', description: 'Read user-submitted bug reports and suggestions.' },
      { value: ADMIN_PERMISSIONS.BUG_REPORTS_REPLY, label: 'Reply to bug reports', description: 'Send a reply or close a bug report.' },
