// Lightweight inline SVG icons for the admin sidebar + pages. Kept as plain
// SVG (no lucide-react dep) so the admin app stays light.
  ...
  if (filled) {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M12 2.6l3.09 6.26L22 9.86l-5 4.87 1.18 6.88L12 18.36l-6.18 3.25L7 14.73 2 9.86l6.91-1z" />
      </svg>
    );
  }
  return (
...
export function MegaphoneIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="m3 11 18-5v12L3 14" />
      <path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" />
    </svg>
  );
}

export function ShieldUserIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" />
      <circle cx="12" cy="11" r="2.5" />
      <path d="M9 17.5c.7-1.5 1.7-2.5 3-2.5s2.3 1 3 2.5" />
    </svg>
  );
}
